...
from .views import dashboard, register, add_workout, add_body_measurement, progress, training_plans, \
    ...
    workout_history, bmi_calculator, tdee_calculator, edit_workout, delete_workout, update_measurement, \
    delete_measurement
...
urlpatterns = [
    ...
    path('pomiary/usun/<int:measurement_id>/', delete_measurement, name='delete_measurement'),
